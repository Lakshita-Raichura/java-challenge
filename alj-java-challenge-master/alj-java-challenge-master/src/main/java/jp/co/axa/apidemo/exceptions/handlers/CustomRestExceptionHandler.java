...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	// define all the different types of exception your employee service can throw.
	// Then accordingly add the custom handling code.
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		return buildResponseEntity(new ApiRuntimeException(error, HttpStatus.BAD_REQUEST, ex.getLocalizedMessage()),
				webRequest);
	}
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		return buildResponseEntity(
				new ApiRuntimeException(error, HttpStatus.BAD_REQUEST, ex.getBindingResult().toString()), webRequest);
	}
	...
	private ResponseEntity<Object> buildResponseEntity(ApiRuntimeException apiRuntimeException, WebRequest webRequest) {
		ApiErrorResponse response = new ApiErrorResponse(apiRuntimeException.getErrorMessage(),
				apiRuntimeException.getErrorStatus().value(), apiRuntimeException.getTimeStamp(),
				apiRuntimeException.getDetailedErrorMessage(),
